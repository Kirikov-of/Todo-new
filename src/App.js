...
function App() {
  return (
    <div class="todo">
      <div class="todo_categories">
        <ul>
          <button class="todo_category">
      ...
      <div class="todo_list">
        ...
        <div class="todo_tasks">
          ...
          <div class="todo_task todo_task-uncomplite">
            <div class="circle">
              <svg
                width="15"
                height="15"
